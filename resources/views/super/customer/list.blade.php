                                        ...
                                        <table class="table table-striped table-bordered base-style">
                                            ...
                                            @foreach($results as $key =>$value)
                                                <tr>
                                                    ...
                                                    <td>
                                                    <form action="{{ route('admin-customer.destroy', $value) }}" method="post" id="userDelf{{$value->id}}">
                                                        @csrf
                                                        @method('delete')
                                                        <a href="{{route('admin-customer.edit', $value->id)}}"><i class="feather icon-edit-2"></i></a>
